...
ODP_SUBSYSTEM_API(packet, odp_packet_t, copy, odp_packet_t pkt, odp_pool_t pool);
...
ODP_SUBSYSTEM_API(packet, int, copy_from_pkt, odp_packet_t dst,
		  uint32_t dst_offset, odp_packet_t src, uint32_t src_offset, uint32_t len);
...
ODP_SUBSYSTEM_API(packet, void, user_ptr_set, odp_packet_t pkt, const void *ctx);
...
ODP_SUBSYSTEM_API(packet, int, l2_offset_set, odp_packet_t pkt, uint32_t offset);
...
ODP_SUBSYSTEM_API(packet, int, l3_offset_set, odp_packet_t pkt, uint32_t offset);
...
ODP_SUBSYSTEM_API(packet, int, l4_offset_set, odp_packet_t pkt, uint32_t offset);
...
ODP_SUBSYSTEM_API(packet, void, flow_hash_set, odp_packet_t pkt, uint32_t flow_hash);
...
ODP_SUBSYSTEM_API(packet, void, color_set, odp_packet_t pkt, odp_packet_color_t color);
ODP_SUBSYSTEM_API(packet, odp_bool_t, drop_eligible, odp_packet_t pkt);
ODP_SUBSYSTEM_API(packet, void, drop_eligible_set, odp_packet_t pkt, odp_bool_t status);
ODP_SUBSYSTEM_API(packet, int8_t, shaper_len_adjust, odp_packet_t pkt);
ODP_SUBSYSTEM_API(packet, void, shaper_len_adjust_set, odp_packet_t pkt, int8_t adj);
...
typedef ODP_MODULE_CLASS(packet) {
	...
	odp_api_proto(packet, unshared_len) packet_unshared_len;
	...
	odp_api_proto(packet, shaper_len_adjust_set) packet_shaper_len_adjust_set;
