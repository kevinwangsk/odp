...
static INLINE void generic_packet_prefetch(odp_packet_t pkt, uint32_t offset,
					   uint32_t len)
{
	return _odp_packet_prefetch(pkt, offset, len);
}

static INLINE void *generic_packet_data(odp_packet_t pkt)
{
	return _odp_packet_data(pkt);
}

static INLINE uint32_t generic_packet_seg_len(odp_packet_t pkt)
{
	return _odp_packet_seg_len(pkt);
}

static INLINE uint32_t generic_packet_len(odp_packet_t pkt)
{
	return _odp_packet_len(pkt);
}

static INLINE uint32_t generic_packet_headroom(odp_packet_t pkt)
{
	return _odp_packet_headroom(pkt);
}

static INLINE uint32_t generic_packet_tailroom(odp_packet_t pkt)
{
	return _odp_packet_tailroom(pkt);
}

static INLINE odp_pool_t generic_packet_pool(odp_packet_t pkt)
{
	return _odp_packet_pool(pkt);
}

static INLINE odp_pktio_t generic_packet_input(odp_packet_t pkt)
{
	return _odp_packet_input(pkt);
}

static INLINE void *generic_packet_user_ptr(odp_packet_t pkt)
{
	return _odp_packet_user_ptr(pkt);
}

static INLINE int generic_packet_num_segs(odp_packet_t pkt)
{
	return _odp_packet_num_segs(pkt);
}

static INLINE void *generic_packet_user_area(odp_packet_t pkt)
{
	return _odp_packet_user_area(pkt);
}

static INLINE uint32_t generic_packet_flow_hash(odp_packet_t pkt)
{
	return _odp_packet_flow_hash(pkt);
}

static INLINE odp_time_t generic_packet_ts(odp_packet_t pkt)
{
	return _odp_packet_ts(pkt);
}

static INLINE void *generic_packet_head(odp_packet_t pkt)
{
	return _odp_packet_head(pkt);
}

static INLINE int generic_packet_is_segmented(odp_packet_t pkt)
{
	return _odp_packet_is_segmented(pkt);
}

static INLINE odp_packet_seg_t generic_packet_first_seg(odp_packet_t pkt)
{
	return _odp_packet_first_seg(pkt);
}

static INLINE odp_packet_seg_t generic_packet_last_seg(odp_packet_t pkt)
{
	return _odp_packet_last_seg(pkt);
}

static INLINE odp_packet_seg_t generic_packet_next_seg(odp_packet_t pkt,
						       odp_packet_seg_t seg)
{
	return _odp_packet_next_seg(pkt, seg);
}

static INLINE int generic_packet_has_l2(odp_packet_t pkt)
{
	return _odp_packet_has_l2(pkt);
}

static INLINE int generic_packet_has_eth(odp_packet_t pkt)
{
	return _odp_packet_has_eth(pkt);
}

static INLINE int generic_packet_has_jumbo(odp_packet_t pkt)
{
	return _odp_packet_has_jumbo(pkt);
}

static INLINE int generic_packet_has_flow_hash(odp_packet_t pkt)
{
	return _odp_packet_has_flow_hash(pkt);
}

static INLINE int generic_packet_has_ts(odp_packet_t pkt)
{
